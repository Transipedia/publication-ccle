...
echo -e "\n STEP 2 : DepMap keeping ID / sample pairs information"
...
echo -e "\n STEP 3 : generate bedfiles and probes fasta file"
...
# STEP 4 : restricting to the chimeras that intersect with exon borders
echo -e "\n STEP 4 : select only exon borders fusions"
